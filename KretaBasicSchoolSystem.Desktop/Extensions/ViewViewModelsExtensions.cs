...
using KretaBasicSchoolSystem.Desktop.Views.SchoolOsztalyzatok;
...
namespace KretaDesktop.Extensions
{
    public static class ViewViewModelsExtensions
    {
        public static void ConfigureViewViewModels(this IServiceCollection services)
        {
            ...
            //SchoolOsztalyzatok
            services.AddSingleton<SchoolOsztalyzatokViewModel>();
            services.AddSingleton<SchoolOsztalyzatokView>(s => new SchoolOsztalyzatokView()
            {
                DataContext = s.GetRequiredService<SchoolOsztalyzatokViewModel>()
            });
